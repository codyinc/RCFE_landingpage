...
(function ($) {
    ...
    /* ------------------  AJAX MAILCHIMP   Hold for now  Done needs to check with Marketing Attorny------------------ */

    $('.mailchimp').ajaxChimp({
        url: "", //Replace with your own mailchimp Campaigns URL.
...
console.log("Navid is debugging")


//<!--End Google Analytics -- >

// fedout sign up box for now 
